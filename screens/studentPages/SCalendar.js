...
export default class SBookingConfirmation extends React.Component {
  render() {
    return (
      <View style={styles.container}>
        {/* Header Beginning */}
          ...
          >
            ...
            <View style={{marginTop:12, marginLeft:100}}>
                <Text style={{fontSize:24, fontWeight:'bold', color:'#fff'}}>Book a lesson</Text>
            </View>
          </View>
        {/* Header Ending */}
        ...
        <TouchableHighlight 
          onPress={() => this.props.navigation.navigate('SBookingConfirmation')}
          style={styles.button}
          >
       <Text 
            style={{
